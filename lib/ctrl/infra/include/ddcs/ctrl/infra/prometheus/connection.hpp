...
// 단일 스크레이프 연결.
// - 순수 메커니즘: recv/send + 버퍼 + IoResult 보고
// - 요청 완료 판정/응답 빌드/reap은 Server가 구동 (정책 없음)
// - HTTP read 후 respond 후 close
...
public:
    ...
    [[nodiscard]] bool assign(Server& server, io::Fd fd, io::ChannelEvents interests) noexcept;
