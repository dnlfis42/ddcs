...
public:
    PolicyService(port::DeviceRoster& roster, domain::DeviceRegistry& devices, CommandService& commands) noexcept
        : roster_{roster}, devices_{devices}, commands_{commands} {}
...
private:
    void command_group(std::string const& group, ddcs::device::Mode mode, common::Clock::time_point now);
